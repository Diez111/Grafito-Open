...
| Comandos | palette-visible | 581 (40 ocultos) + 15 acciones UI = 596 en paleta | command_registry.rs + grafito-ui/src/command_palette.rs (R3.1: Rename stub→visible; 3D-A2: +Vista3D; P0.2: +41 álgebra; P0.3: +7 complejo; P0.4: +3 demostración; P0.5: +8 optimización+gráficos; P1: +82 listas/estadística/probabilidad; P1b: +1 List persistible; P2: +25 medidas/geometría; P3b: +11 scripting + Execute real; P4: +105 CAS/listas/geometría/stats/display) |
...
| 621 comandos (`command!(`), 581 visibles + 15 UI = 596 en paleta | `crates/grafito-command/src/command_registry.rs` (R3.1: Rename visible; 3D-A2: +Vista3D; P0.2: +41 álgebra; P0.3: +7 complejo; P0.4: +3 demostración; P0.5: +8 optimización+gráficos; P1: +82 listas/estadística/probabilidad; P1b: +1 List persistible; P2: +25 medidas/geometría; P3b: +11 scripting + Execute real; P4: +105 CAS/listas/geometría/stats/display) |
...
> (581 visibles + 15 UI = 596 en paleta), i18n ES/EN/PT/IT/FR/DE (187 claves),
