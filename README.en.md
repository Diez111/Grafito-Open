...
| **Command Palette** | Ctrl+K | 621 registered commands (581 palette-visible) across 25 categories + 15 UI actions, fuzzy bilingual search, arrow navigation, syntax template insertion |
