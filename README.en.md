...
| **Command Palette** | Ctrl+K | 639 registered commands (599 palette-visible) across 25 categories + 15 UI actions, fuzzy bilingual search, arrow navigation, syntax template insertion |
