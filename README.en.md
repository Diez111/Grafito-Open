...
- [Features](#features)
  ...
  - [Math Engine](#math-engine-grafito-geometry)
  - [Statistics and Probability](#statistics-and-probability)
  - [3D Viewport](#3d-viewport)
  - [GPU Compute Shaders](#gpu-compute-shaders-webgpu-via-wgpu)
  - [UI / UX](#ui--ux)
...
> Requires Rust 1.92+ and a C toolchain (`build-essential` on Debian/Ubuntu). GPU compute shaders need Vulkan, Metal, or DX12 support.
...
| Full analysis | `Analyze[f]` | Roots, extrema, inflection, intercepts, asymptotes, Taylor | 1e-9 |
...
| Curvature | `CurvatureAt[f, x]` | κ = |f''| / (1+f'²)^(3/2) | Numerical |
| Volume of revolution | `VolumeOfRevolution[f, a, b]` | π * integral(f²) | Numerical |
| Surface of revolution | `SurfaceOfRevolution[f, a, b]` | 2π * integral(|f| * sqrt(1+f'²)) | Numerical |
...
**14 special curves**: Cardioid, Rose, Archimedean Spiral, Logarithmic Spiral, Lissajous, Epicycloid, Hypocycloid.
...
| **Command Palette** | Ctrl+K | 650 registered commands (613 palette-visible) across 25 categories + 15 UI actions, fuzzy bilingual search, arrow navigation, syntax template insertion |
...
│   ├── grafito-core/        Document model, 32+ object types, spatial index, constraints
