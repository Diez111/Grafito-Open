...
pub fn all_commands() -> Vec<PaletteCommand> {
    vec![
        ...
        PaletteCommand { name: "Taylor", category: "CAS", syntax_hint: "Taylor[expr, x, x0, order]" },
        
        // Matrices
        PaletteCommand { name: "Determinant", category: "Matrices", syntax_hint: "Determinant[[a,b],[c,d]]" },
        PaletteCommand { name: "Inverse", category: "Matrices", syntax_hint: "Inverse[[a,b],[c,d]]" },
        PaletteCommand { name: "SolveSystem", category: "Matrices", syntax_hint: "SolveSystem[[a,b],[c,d],[e,f]]" },
        ...
        // Statistics
        PaletteCommand { name: "Histogram", category: "Statistics", syntax_hint: "Histogram[{data}, bins]" },
        PaletteCommand { name: "ScatterPlot", category: "Statistics", syntax_hint: "ScatterPlot[{xs}, {ys}]" },
        PaletteCommand { name: "BoxPlot", category: "Statistics", syntax_hint: "BoxPlot[{data}]" },
        PaletteCommand { name: "LinearRegression", category: "Statistics", syntax_hint: "LinearRegression[{xs}, {ys}]" },
        PaletteCommand { name: "Mean", category: "Statistics", syntax_hint: "Mean[{data}]" },
        PaletteCommand { name: "Median", category: "Statistics", syntax_hint: "Median[{data}]" },
        PaletteCommand { name: "StdDev", category: "Statistics", syntax_hint: "StdDev[{data}]" },
        PaletteCommand { name: "Correlation", category: "Statistics", syntax_hint: "Correlation[{xs}, {ys}]" },
        
        // Attractors
        PaletteCommand { name: "Lorenz", category: "Attractors", syntax_hint: "Lorenz[] | Lorenz[sigma, rho, beta]" },
        PaletteCommand { name: "Rossler", category: "Attractors", syntax_hint: "Rossler[] | Rossler[a, b, c]" },
        PaletteCommand { name: "Thomas (Butterfly)", category: "Attractors", syntax_hint: "Thomas[] | Butterfly[]" },
        PaletteCommand { name: "Aizawa", category: "Attractors", syntax_hint: "Aizawa[]" },
        PaletteCommand { name: "Chen", category: "Attractors", syntax_hint: "Chen[]" },
        PaletteCommand { name: "Halvorsen", category: "Attractors", syntax_hint: "Halvorsen[]" },
        PaletteCommand { name: "Dadras", category: "Attractors", syntax_hint: "Dadras[]" },
        PaletteCommand { name: "Chua", category: "Attractors", syntax_hint: "Chua[]" },
        
        // Fractals
        PaletteCommand { name: "Mandelbrot", category: "Fractals", syntax_hint: "Mandelbrot[] | Mandelbrot[max_iter]" },
        PaletteCommand { name: "Julia", category: "Fractals", syntax_hint: "Julia[cr, ci] | Julia[cr, ci, max_iter]" },
        PaletteCommand { name: "BurningShip", category: "Fractals", syntax_hint: "BurningShip[]" },
        
        // 4D
        PaletteCommand { name: "Hypercube", category: "4D", syntax_hint: "Hypercube[] | Hypercube[a1, a2, a3]" },
        PaletteCommand { name: "Hypersphere", category: "4D", syntax_hint: "Hypersphere[]" },
        ...
        PaletteCommand { name: "VectorField3D", category: "3D", syntax_hint: "VectorField3D[u, v, w]" },
                    ...
                    egui::ScrollArea::vertical()
                        ...
                        .show(ui, |ui| {
                            for (i, cmd) in filtered.iter().enumerate() {
                                ...
                                let response = ui.selectable_label(is_selected, format!("{} — {}", cmd.name, cmd.category));
