...
const ASSISTANT_GRAPH_CAPABILITIES: &[AssistantGraphCapability] = &[
    ...
    // --- 39 capacidades 2D constructivas faltantes (para consciencia total) ---
    AssistantGraphCapability {
        canonical: "Point",
        syntax: "Point[(x, y)]",
        help: "Crea un punto 2D.",
        keywords: &["punto", "point"],
        min_args: 1,
        max_args: 1,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Circle",
        syntax: "Circle[centro, radio]",
        help: "Crea un círculo.",
        keywords: &["circulo", "círculo", "circle"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        ...
        help: "Crea un polígono.",
        keywords: &["poligono", "polígono", "polygon"],
        min_args: 1,
        max_args: 64,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        ...
        help: "Crea una elipse.",
        keywords: &["elipse", "ellipse"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Parabola",
        syntax: "Parabola[(vx, vy), p]",
        help: "Crea una parábola.",
        keywords: &["parabola", "parábola"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Hyperbola",
        syntax: "Hyperbola[(cx, cy), a, b]",
        help: "Crea una hipérbola.",
        keywords: &["hiperbola", "hipérbola", "hyperbola"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "RegularPolygon",
        syntax: "RegularPolygon[(cx, cy), n, r]",
        help: "Crea un polígono regular.",
        keywords: &["regular", "poligono", "polygon"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "SampledGraph",
        syntax: "SampledGraph[expr, range]",
        help: "Grafica una función muestreada.",
        keywords: &["muestreada", "sampled", "grafica"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        ...
        syntax: "Perpendicular[punto, recta]",
        help: "Construye una perpendicular.",
    ...
    AssistantGraphCapability {
        canonical: "Parallel",
        syntax: "Parallel[punto, recta]",
        help: "Construye una paralela.",
        keywords: &["paralela", "parallel", "paralelo"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Tangent",
        syntax: "Tangent[obj1, obj2]",
        help: "Construye una tangente.",
        keywords: &["tangente", "tangent"],
        min_args: 2,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PerpendicularBisector",
        syntax: "PerpendicularBisector[(x1, y1), (x2, y2)]",
        help: "Construye la mediatriz.",
        keywords: &["mediatriz", "bisector"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "AngleBisector",
        syntax: "AngleBisector[p1, vertice, p2]",
        help: "Construye la bisectriz.",
        keywords: &["bisectriz", "bisector"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Midpoint",
        syntax: "Midpoint[A, B]",
        help: "Crea el punto medio.",
        keywords: &["medio", "midpoint", "punto medio"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        ...
        help: "Crea una recta infinita.",
        keywords: &["recta", "line", "línea"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Segment",
        syntax: "Segment[(x1, y1), (x2, y2)]",
        help: "Crea un segmento.",
        keywords: &["segmento", "segment"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Ray",
        syntax: "Ray[(x1, y1), (x2, y2)]",
        help: "Crea una semirrecta.",
        keywords: &["rayo", "ray", "semirrecta"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Translate",
        syntax: "Translate[punto, (dx, dy)]",
        help: "Traslada un punto.",
        keywords: &["traslacion", "traslación", "translate"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Rotate",
        syntax: "Rotate[punto, centro, angulo]",
        help: "Rota un punto.",
        keywords: &["rotacion", "rotación", "rotate", "rotar"],
        min_args: 2,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Dilate",
        syntax: "Dilate[punto, factor, centro]",
        help: "Dilata un punto.",
        keywords: &["dilatar", "dilate", "homotecia"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Reflect",
        syntax: "Reflect[obj, punto_a, punto_b]",
        help: "Refleja un objeto.",
        keywords: &["reflejar", "reflect", "simetria", "simetría"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Distance",
        syntax: "Distance[A, B, valor]",
        help: "Fija una distancia.",
        keywords: &["distancia", "distance"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Angle",
        syntax: "Angle[l1, l2, grados]",
        help: "Fija un ángulo.",
        keywords: &["angulo", "ángulo", "angle"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Coincident",
        syntax: "Coincident[A, B]",
        help: "Hace coincidir dos puntos.",
        keywords: &["coincidir", "coincident"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        ...
        syntax: "Horizontal[obj]",
        help: "Fuerza horizontal.",
        keywords: &["horizontal"],
        min_args: 1,
        max_args: 1,
        view: AssistantGraphView::TwoD,
    ...
    AssistantGraphCapability {
        canonical: "EqualLength",
        syntax: "EqualLength[s1, s2]",
        help: "Iguala longitudes.",
        keywords: &["igual", "equal", "longitud"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "Symmetry",
        syntax: "Symmetry[P, Q, eje]",
        help: "Simetría axial.",
        keywords: &["simetria", "simetría", "symmetry"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "EllipseByFoci",
        syntax: "EllipseByFoci[F1, F2, P]",
        help: "Elipse por focos.",
        keywords: &["elipse", "focos", "ellipse"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "ParabolaByFocusDirectrix",
        syntax: "ParabolaByFocusDirectrix[F, d]",
        help: "Parábola por foco y directriz.",
    ...
    AssistantGraphCapability {
        canonical: "HyperbolaByFoci",
        syntax: "HyperbolaByFoci[F1, F2, P]",
        help: "Hipérbola por focos.",
        keywords: &["hiperbola", "hipérbola", "focos"],
        min_args: 3,
        max_args: 3,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "ConicByFivePoints",
        syntax: "ConicByFivePoints[A, B, C, D, E]",
        help: "Cónica por cinco puntos.",
        keywords: &["conica", "cónica", "five", "puntos"],
        min_args: 5,
        max_args: 5,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PolygonUnion",
        syntax: "PolygonUnion[poly1, poly2]",
        help: "Unión de polígonos.",
        keywords: &["union", "unión", "polygon"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PolygonIntersection",
        syntax: "PolygonIntersection[poly1, poly2]",
        help: "Intersección de polígonos.",
        keywords: &["interseccion", "intersección", "polygon"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PolygonDifference",
        syntax: "PolygonDifference[poly1, poly2]",
        help: "Diferencia de polígonos.",
        keywords: &["diferencia", "difference", "polygon"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PolygonXor",
        syntax: "PolygonXor[poly1, poly2]",
        help: "Xor de polígonos.",
        keywords: &["xor", "polygon"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "PointExpr",
        syntax: "PointExpr[x_expr, y_expr]",
        help: "Punto ligado a expresiones.",
        keywords: &["punto", "expresion", "expresión"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
    ...
    AssistantGraphCapability {
        canonical: "CircleExpr",
        syntax: "CircleExpr[centro, radius_expr]",
        help: "Círculo ligado a expresión.",
        keywords: &["circulo", "círculo", "expresion"],
        min_args: 2,
        max_args: 2,
        view: AssistantGraphView::TwoD,
        proof: AssistantGraphProof::StaticTwoD,
