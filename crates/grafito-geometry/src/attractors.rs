...
impl AttractorType {
    ...
    pub fn halvorsen() -> Self {
        Self::Halvorsen { a: 1.89 }
    }
    pub fn dadras() -> Self {
        Self::Dadras {
            p: 3.0,
    ...
    pub fn sprott() -> Self {
        Self::Sprott { a: 2.07, b: 1.79 }
    }
    pub fn three_scroll() -> Self {
        Self::ThreeScroll {
            a: 0.4,
            b: 0.01,
            c: 0.3,
...
fn deriv(attractor: &AttractorType, x: f64, y: f64, z: f64) -> (f64, f64, f64) {
    match attractor {
        ...
        AttractorType::Rossler { a, b, c } => (-(y + z), x + a * y, b + z * (x - c)),
        AttractorType::Thomas { b } => (y.sin() - b * x, z.sin() - b * y, x.sin() - b * z),
        ...
        AttractorType::Dadras { p, q, r, s, e } => {
            (y - p * x + q * y * z, r * y - x * z + z, s * x * y - e * z)
        }
        AttractorType::Chua {
            alpha,
            beta,
